        ...
        <div className="min-h-screen bg-gray-900 py-8 px-4 text-white">
            ...
            <div className="max-w-6xl mx-auto grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {filteredItems.map((item) => (
                    <div
                        key={item.id}
                        className="overflow-hidden flex flex-col items-center bg-gray-800 rounded-lg transition-transform duration-300 hover:scale-105 group"
                    >
                        {/* کادر عکس */}
                        <div className="relative w-full h-64 flex items-center justify-center overflow-hidden p-1">
                            <img
                                ...
                                alt={item.name}
                                className="w-[85%] h-[85%] object-contain rounded-lg transition-all duration-500
                  group-hover:shadow-[0_0_30px_rgba(250,204,21,0.6),0_0_60px_rgba(255,255,255,0.3)]
